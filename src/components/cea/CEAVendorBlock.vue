...
import CEAVendorVESAAdaptiveSync from './vsdb/CEAVendorVESAAdaptiveSync.vue'
...
// Tag 0x03 VSDBs (HDMI 1.4, HDMI Forum, Microsoft HMD, AMD, HDR10+, VESA Adaptive-Sync, NVIDIA)
...
<template>
  <div class="space-y-6">
    ...
    <template v-for="(block, i) in vsdbs" :key="`vsdb-${i}`">
      ...
      <CEAVendorVESAAdaptiveSync v-else-if="block.vendor?.kind === 'vesaAdaptiveSync'" :fields="block.vendor.fields" />

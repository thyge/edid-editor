      ...
      <div v-for="{ block, index } in blocksByTag<DisplayIdDisplayInterfaceFeaturesBlock>(props.displayId, DisplayIdDataBlockTag.DisplayInterfaceFeatures, props.index)" :key="index" class="space-y-5">
        ...
        <section class="space-y-2">
          ...
          <div class="grid grid-cols-3 gap-3">
            <label class="flex items-center justify-between rounded-md px-3 py-2 hover:bg-muted/50"><span>32 kHz</span><Switch :model-value="block.audioSampleRates.sr32kHz" @update:model-value="(value: boolean) => update(index, block, { audioSampleRates: { ...block.audioSampleRates, sr32kHz: value } })" /></label>
            <label class="flex items-center justify-between rounded-md px-3 py-2 hover:bg-muted/50"><span>44.1 kHz</span><Switch :model-value="block.audioSampleRates.sr44_1kHz" @update:model-value="(value: boolean) => update(index, block, { audioSampleRates: { ...block.audioSampleRates, sr44_1kHz: value } })" /></label>
            <label class="flex items-center justify-between rounded-md px-3 py-2 hover:bg-muted/50"><span>48 kHz</span><Switch :model-value="block.audioSampleRates.sr48kHz" @update:model-value="(value: boolean) => update(index, block, { audioSampleRates: { ...block.audioSampleRates, sr48kHz: value } })" /></label>
          </div>
        </section>
        ...
        <section class="space-y-2">
          ...
          <div class="grid grid-cols-2 gap-3">
            <label class="flex items-center justify-between rounded-md px-3 py-2 hover:bg-muted/50"><span>sRGB</span><Switch :model-value="block.colorSpaceEotfStandard1.srgb" @update:model-value="(value: boolean) => update(index, block, { colorSpaceEotfStandard1: { ...block.colorSpaceEotfStandard1, srgb: value } })" /></label>
            <label class="flex items-center justify-between rounded-md px-3 py-2 hover:bg-muted/50"><span>BT.601</span><Switch :model-value="block.colorSpaceEotfStandard1.bt601" @update:model-value="(value: boolean) => update(index, block, { colorSpaceEotfStandard1: { ...block.colorSpaceEotfStandard1, bt601: value } })" /></label>
            <label class="flex items-center justify-between rounded-md px-3 py-2 hover:bg-muted/50"><span>BT.709 / BT.1886</span><Switch :model-value="block.colorSpaceEotfStandard1.bt709Bt1886" @update:model-value="(value: boolean) => update(index, block, { colorSpaceEotfStandard1: { ...block.colorSpaceEotfStandard1, bt709Bt1886: value } })" /></label>
            <label class="flex items-center justify-between rounded-md px-3 py-2 hover:bg-muted/50"><span>Adobe RGB</span><Switch :model-value="block.colorSpaceEotfStandard1.adobeRgb" @update:model-value="(value: boolean) => update(index, block, { colorSpaceEotfStandard1: { ...block.colorSpaceEotfStandard1, adobeRgb: value } })" /></label>
            <label class="flex items-center justify-between rounded-md px-3 py-2 hover:bg-muted/50"><span>DCI-P3</span><Switch :model-value="block.colorSpaceEotfStandard1.dciP3" @update:model-value="(value: boolean) => update(index, block, { colorSpaceEotfStandard1: { ...block.colorSpaceEotfStandard1, dciP3: value } })" /></label>
            <label class="flex items-center justify-between rounded-md px-3 py-2 hover:bg-muted/50"><span>BT.2020</span><Switch :model-value="block.colorSpaceEotfStandard1.bt2020" @update:model-value="(value: boolean) => update(index, block, { colorSpaceEotfStandard1: { ...block.colorSpaceEotfStandard1, bt2020: value } })" /></label>
            <label class="flex items-center justify-between rounded-md px-3 py-2 hover:bg-muted/50 col-span-2"><span>BT.2020 / SMPTE ST 2084</span><Switch :model-value="block.colorSpaceEotfStandard1.bt2020St2084" @update:model-value="(value: boolean) => update(index, block, { colorSpaceEotfStandard1: { ...block.colorSpaceEotfStandard1, bt2020St2084: value } })" /></label>
          </div>
        </section>
